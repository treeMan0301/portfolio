    ...
    <React.Fragment>
      <section className="about-me relative mt-16 " id="about-me" ref={ref}>
        ...
        <div className="flex flex-row justify-center gap-6 items-center pl-32 pr-32 mb-16  max-lg:flex-col max-lg:p-16 min-[1921px]:px-[45rem] min-[1921px]:mb-48">
          ...
          >
            <SwiperSlide className="bg-[--darkblue] text-[--white] flex flex-col justify-center items-start gap-24 rounded-2xl p-20 border-solid border-[0.4rem] border-[--lightblue] hover:border-orange duration-500 transition-all text-left max-lg:p-10 cursor-grab">
              <div className="flex gap-6 flex-row justify-start items-center max-lg:flex-col max-lg:justify-center max-lg:text-center ">
                <div>
                  <img src={caricon} alt={caricon} className="w-24" />
                </div>
                <div>
                  <h2>Education</h2>
                </div>
              ...
              <div className="flex flex-row gap-10 max-lg:flex-col">
                ...
                <div>
                  <h3 className="text-white text-3xl">
                    University of Texas at El Paso, 2013 - 2017
                  </h3>
              ...
              <div className="flex flex-row gap-10 max-lg:flex-col">
                ...
                <div>
                  <h5 className="text-white text-2xl">
                    ...
                    Expedia Group, Oct 2021 - Dec 2024
                  </h5>
                  <h5 className="text-white text-2xl">
                    Full Stack Developer <br /> 
                    100Devs, Feb 2020 - Jul 2021
                  </h5>
                  <h5 className="text-white text-2xl">
                    Frontend Developer <br />
                    Other World Computing, Nov 2017 - Jan 2020
                  </h5>
                </div>
              </div>
            </SwiperSlide>
